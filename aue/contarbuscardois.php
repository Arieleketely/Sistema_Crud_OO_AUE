...
<html lang="pt-br">
    ...
    <body>
        ...
        ?>
        <form style='margin:10px';method="POST" action="contarconsultarbuscardois.php" style='margin:10px';>
        <div class="form-row">
        <div class="form-group col-md-3">
            ...
            <input class="btn btn-primary" type="submit" value="Buscar"  style='margin:2px';>
        </form>
        <br>
